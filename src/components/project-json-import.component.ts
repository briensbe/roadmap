...
@Component({
  ...
  template: `
    <button type="button" class="json-import-btn" (click)="showPopup = true" title="Importer depuis JSON">
    ...
    <div *ngIf="showPopup" class="json-popup-overlay" (click)="showPopup = false">
      <div class="json-popup" (click)="$event.stopPropagation()">
        ...
        <div class="json-popup-body">
          ...
          <textarea [(ngModel)]="jsonInput" placeholder='{ "id": "...", "titre": "...", ... }' rows="10"></textarea>
          <div *ngIf="errorMessage" class="error-message">
            {{ errorMessage }}
          </div>
        </div>
        <div class="json-popup-footer">
          <button type="button" class="btn btn-secondary" (click)="showPopup = false">Annuler</button>

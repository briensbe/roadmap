...
@Component({
      ...
      <div class="modal" (click)="$event.stopPropagation()">
        ...
        <form (ngSubmit)="save()" class="form">
          ...
          <div class="form-group full-width" [class.has-error]="formErrors.nom_projet">
            ...
            <input [(ngModel)]="editableProjet.nom_projet" name="nom" required (ngModelChange)="formErrors.nom_projet = false" />
          ...
          <div class="form-group full-width">
            ...
            <div class="color-palette">
              ...
              >
                <div *ngIf="isCustomColor; else plusIcon" class="custom-preview" [style.background-color]="editableProjet.color"></div>
            ...
            <div *ngIf="isCustomColor" class="custom-color-input-wrapper">
              ...
              <input type="text" [(ngModel)]="ngModelColor" (ngModelChange)="onColorHexChange($event)" name="customColorText" class="color-hex-input" placeholder="#HEXCODE" />
            </div>
          </div>
  ...
  styles: [`
    ...
    .label-with-link { display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px; }
    .label-with-link label { margin-bottom: 0 !important; }
    .modal-ref-link { font-size: 11px; background: #f3f4f6; padding: 2px 8px; border-radius: 4px; border: 1px solid #e5e7eb; color: #4f46e5; text-decoration: none; display: flex; align-items: center; gap: 4px; }
...
export class ProjectModalComponent implements OnInit {
  ...
  async ngOnInit() {
    this.editableProjet = this.projet ? { ...this.projet } : {
      code_projet: "",
      nom_projet: "",
      statut: "En cours",
      description: "",

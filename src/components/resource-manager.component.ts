      ...
      <div class="tab-content">
        <div *ngIf="activeTab === 'societe'" class="resource-section">
          ...
          <div class="resource-list">
            <div *ngFor="let societe of societes" class="resource-item">
              {{ societe.nom }}
            </div>
          </div>
        ...
        <div *ngIf="activeTab === 'departement'" class="resource-section">
          ...
          <div class="resource-list">
            <div *ngFor="let dept of departements" class="resource-item">
              {{ dept.nom }}
            </div>
          </div>
        ...
        <div *ngIf="activeTab === 'service'" class="resource-section">
          ...
          <div class="resource-list">
            <div *ngFor="let service of services" class="resource-item">
              {{ service.nom }}
            </div>
          </div>
        ...
        <div *ngIf="activeTab === 'equipe'" class="resource-section">
          ...
          <div class="resource-list">
            <div *ngFor="let equipe of equipes" class="resource-item">
              {{ equipe.nom }}
            </div>
          </div>
        ...
        <div *ngIf="activeTab === 'role'" class="resource-section">
          ...
          <div class="resource-list">
            <div *ngFor="let role of roles" class="resource-item">
              <span>{{ role.nom }}</span>
          ...
          <div *ngIf="showAddRole" class="inline-form">
            ...
            <input type="number" [(ngModel)]="newRole.jours_par_semaine"
                   placeholder="Jours/semaine" step="0.5" min="0.5" max="7">
        ...
        <div *ngIf="activeTab === 'personne'" class="resource-section">
          ...
          <div class="resource-list">
            <div *ngFor="let personne of personnes" class="resource-item">
          ...
          <div *ngIf="showAddPersonne" class="inline-form">
            ...
            <input type="number" [(ngModel)]="newPersonne.jours_par_semaine"
                   placeholder="Jours/semaine" step="0.5" min="0.5" max="7">
